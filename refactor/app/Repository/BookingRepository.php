    ...
    public function store($user, $data)
    {
        ...
        if ($user->user_type == env('CUSTOMER_ROLE_ID')) {
            ...
            if (!isset($data['from_language_id'])) {
                ...
                // ORIGINAL CODE BEFORE REFACTORED:
            ...
            if ($data['immediate'] == 'no') {
                ...
                // ORIGINAL CODE BEFORE REFACTORED: if (isset($data['due_date']) && $data['due_date'] == '')
                // AFTER REFACTORED:
                ...
                // ORIGINAL CODE BEFORE REFACTORED: if (isset($data['due_time']) && $data['due_time'] == '')
                // AFTER REFACTORED:
                ...
                // ORIGINAL CODE BEFORE REFACTORED: if (isset($data['duration']) && $data['duration'] == '')
                // AFTER REFACTORED:
